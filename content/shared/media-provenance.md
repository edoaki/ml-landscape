...
> 2026-09-24: 配信物を軽量化しました。以下の記録にある素材のうち、どのページからも参照されていなかった109件（別フォルダへ移した素材の重複コピー、差し替え前の図、未使用の動画・音声など）を `assets/` から削除しました。ページ専用フォルダでも、どのページからも読み込まれない `low.wav`・`mix.wav`（音声）、`gradcam-original.png`（頑健性）、`reliability.svg`（基本概念）を削除しました。Git履歴から復元できます。SAM 2の連番フレームは `content/fields/video/media/` へ移しました。次の動画は内容・尺を変えずにH.264（CRF 27、30 fps以下、音声AAC 96 kbps）へ再圧縮しました：`gns-water.mp4`、`sora-tokyo-clip.mp4`、`3dgs-bicycle.mp4`、`genie3-racetrack.mp4`、`decision-orbit.mp4`、`nerf-result.mp4`。次のPNGは画素値を変えずに可逆再圧縮しました：`orb-slam3-figure6.png`、`dino-self-supervised.png`、`dino-supervised.png`、`blazepose-fig6-yoga1.png`、`blazepose-fig6-yoga2.png`、`pose-result.png`、`diffusion-cat-stages.png`。以下の「無加工」「バイト単位で保持」は、これらの処理より前の記録です。
>
> 削除したファイル：`alphafold-fig1.png`、`alphafold-fig1e.png`、`app.js`、`attention-matrix.svg`、`audio-musicgen-dance.mp3`、`audio-musicgen-orchestra.mp3`、`audio-score-backing.wav`、`audio-score-melody.wav`、`audio-score-mix.wav`、`audio-score.svg`、`audio-spectrogram.png`、`audio-tacotron2-generated.wav`、`audio-tacotron2-human.wav`、`audio-tts-fast.wav`、`audio-tts-normal.wav`、`audio-waveform.png`、`audio.js`、`blazepose-fig6-yoga1.png`、`blazepose-fig6-yoga2.png`、`convolution.svg`、`coordinate-field.svg`、`decision-breakout-poster.jpg`、`decision-breakout.mp4`、`decision-diamond-poster.jpg`、`decision-diamond.mp4`、`decision-orbit-poster.jpg`、`decision-orbit.mp4`、`decision-space-invaders-poster.jpg`、`decision-space-invaders.mp4`、`depth-bicycle-input.jpg`、`depth-bicycle-result.jpg`、`depth-input.jpg`、`depth-result.jpg`、`dgmr-rain-poster.jpg`、`dgmr-rain.mp4`、`dice-counterfactual.gif`、`diffusion-cat-stages.png`、`diffusion-stages.svg`、`dino-self-supervised.png`、`dino-supervised.png`、`flow-density.svg`、`fm.js`、`fno-fig2.png`、`genie-figure1.png`、`genie-inference.png`、`genie3-library-cat.webm`、`genie3-racetrack.webm`、`gns-water.mp4`、`gradcam-cat.png`、`gradcam-dog.png`、`gradcam-original.png`、`graphcast-fig1.png`、`graphcast-fig1abc.png`、`high.wav`、`hippo-framework.png`、`hippo-measures.png`、`induction-original.png`、`kool2019-tsp-decoder.png`、`language.js`、`latent.svg`、`llava-ironing.png`、`low.wav`、`mamba-copying.svg`、`mamba-selection.svg`、`merlion-result.png`、`mix.wav`、`mnist-train-00000-label-5.png`、`nerf-author-rendering.png`、`optimization-descent-poster.jpg`、`orb-outdoors1-1-display.png`、`orb-outdoors1-1.png`、`orb-outdoors1-2-display.png`、`orb-outdoors1-2.png`、`orb-outdoors1-3-display.png`、`orb-outdoors1-3.png`、`orb-outdoors1-4.png`、`orb-outdoors1-5.png`、`orb-outdoors1-6-display.png`、`orb-outdoors1-6.png`、`orb-slam3-figure1.png`、`pose-result.png`、`pose.svg`、`protein.svg`、`raft-figure1.png`、`raft-results.png`、`reliability.svg`、`rfdiffusion-binder.png`、`rfdiffusion-fig1.png`、`rfdiffusion-fig1b.png`、`rnn-unroll.svg`、`routing.svg`、`rt2-result-poster.jpg`、`rt2-result.mp4`、`sam2-author-model.png`、`scgen-fig1.png`、`science.js`、`slam-input.svg`、`sora-tokyo.mp4`、`spatial-pointcloud-simple.svg`、`spatial.js`、`ssm.js`、`timeseries.js`、`timeseries.svg`、`timesfm-result.png`、`transport.svg`、`tum-vi-inputs.png`、`utkface-train-2000-age-30.jpg`、`utkface-train-2001-age-35.jpg`、`xai-ig.png`。
